...
const Portfolio = () => {
    const [portfolios, setPortfolios] = useState([
        {
            ...
            image: "https://img.freepik.com/free-vector/gradient-interview-portfolio-template_23-2149220443.jpg ",
            description: "A modern e-commerce platform with advanced features.",
        },
        {
            id: 2,
            title: "Mobile Banking App",
            image: " https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSjiLsWdAlncgZL09M1u0ENIwiD19Lf6Y3VNw&s",
            description: "A secure mobile banking application.",
        },
        {
            id: 3,
            title: "Portfolio Website",
            image: " https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcT1xUBVEHBAGxCUlcE8rvOYJ2Nmd_cz6k2MupuZKeYk9WjcvQzgZaYalcLL4y4jympoB90&usqp=CAU",
            description: "A personal portfolio showcasing skills and projects.",
        },
        {
            id: 4,
            title: "Social Media Platform",
            image: " https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQ-acrbeWSjzLRLAUpeZ9C2Wu3EcdWIUch6wg&s",
            description: "A scalable social media platform for networking.",
        },
        {
            id: 5,
            title: "Food Delivery App",
            image: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcS4-450q5OW6QmWjPZKqxeQOX3KQaw8-ZDSQw&s ",
            description: "A food delivery app with real-time tracking.",
        },
        {
            id: 6,
            title: "Weather App",
            image: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSVXgiInjR-O1eERM-dvH3qZHxzJmXI7Qtu7w&s ",
            description: "A weather application with live updates.",
        },
        {
            id: 7,
            title: "CRM Dashboard",
            image: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcT6Bx1hKaqJXKKgdn47gmGbQPlBJ8PNaR6Xjg&s ",
    ...
    const handleSavePortfolio = () => {
        setPortfolios((prev) =>
            prev.map((p) =>
                p.id === selectedPortfolio.id ? selectedPortfolio : p
            )
        );
                ...
                <Modal open={modalOpen} onClose={handleCloseEditModal}>
                    <div className="modal-content">
                        ...
                        <TextField
                            ...
                            onChange={(e) => handleEditPortfolio("description", e.target.value)}
                            fullWidth
                            multiline
                            rows={4}
                            sx={{ mt: 2 }}
                        />
                        <Button onClick={handleSavePortfolio} variant="contained" sx={{ mt: 2 }}>
                            Save
                        </Button>
                    </div>
                </Modal>
