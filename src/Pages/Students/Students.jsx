...
export default function Students() {
  ...
  const allStudents = [
    ...
    {
      picture:
        "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSFxQu84PuCD_zpL1Yv_Gr4C7lNzm2L9fR7CA&s",
      name: "Sara Khan",
    ...
    {
      picture:
        "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcS90MxQZsHnokLBVizSnbHCy420QRu1AupPYBn6Pv9nt164IaePz4L8Cdc0X5AlDgAXPkU&usqp=CAU",
      name: "Ali Raza",
    ...
    {
      picture:
        "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSS3mr0rOaAemqvSNKmzBD-I6mcpod9HFQuCw&s",
      name: "Sara Ali",
  ...
  return (
    <div className="application-student-main">
      <div>
        {!showAdvancedSearch ? (
          <div className="search-bar-container">
            ...
            >
              ...
              />
              <Button size="small" className="search-button">
                Search
              </Button>
            </Box>
            <Button
          ...
          <div>
            <h1 className="advance-search-title"> Advance Search</h1>
            <div className="application-filter">
              <div className="application-filter-left">
                <Box className="application-filter-row-advance">
                  <Typography className="location-title">Locations</Typography>
                </Box>
                <Box className="application-filter-row">
                  <FormControl fullWidth className="custom-select" size="small">
                    <InputLabel className="custom-input-label">
                      Country
                    </InputLabel>
                    <Select
                ...
                <Box className="application-filter-row-advance">
                  <Typography className="location-title">Experience</Typography>
                </Box>
                <Box className="application-filter-row">
                  <FormControl fullWidth className="custom-select" size="small">
                    <InputLabel className="custom-input-label">
              ...
              <div className="application-filter-right">
                <Box className="application-filter-row-advance">
                  <Typography className="location-title">Education</Typography>
                </Box>
                <Box className="application-filter-row">
                  <FormControl fullWidth className="custom-select" size="small">
                    <InputLabel className="custom-input-label">
      ...
      <Box className="application-tabs" sx={{ width: "100%" }}>
        <Tabs
          ...
          sx={{
            "& .MuiTab-root": { color: "#797979", fontSize: "12px" },
          }}
        >
          <Tab
            label="Top Match"
          ...
          <div className="application-recently-hired">
            <FormControlLabel
              className="recent-hired-label"
              control={
                <Switch className="recent-hired-checked" defaultChecked />
              }
              ...
              {allStudents.map((student, index) => (
                <div className="application-student-card">
                  <div className="student-card-header">
                    ...
                    <div className="student-card-header-info-rating">
                  ...
                  <div className="application-card-actions">
                    <Button
                      variant="contained"
                      className="card-actions-message"
                      size="small"
                    >
                      Message
                    </Button>
